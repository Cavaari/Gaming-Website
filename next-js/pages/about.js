...
export default function About() {
    return (
        <div className="p-3 bg-third d-flex flex-column align-items-center mx-auto">
            ...
            <div class="mt-3 mb-3 w-100 row row-cols-1 row-cols-md-3 row-cols-lg-6 g-2 d-flex  justify-content-around">
                ...
                <Card name="Egor" imgSrc="/runeTextures/Blue/Rectangle/runeBlue_rectangle_001.png" descirption="Egor's description" link="/about/eivanov"/>
