...
export default function About() {
    return (
        <div className="p-5 bg-primary d-flex flex-column align-items-center mx-auto">
            <h1 style={{fontSize: "5rem"}} className="text-secodary text-center align-self-md-start">About Us</h1>
            <div className="mt-3 mb-3 w-100 row row-cols-1 row-cols-md-3 row-cols-lg-4 g-2 d-flex justify-content-around">
                ...
                <Card name="Cavaari Taylor" imgSrc="/about/Memoji.png" description="An island boy with a passion for programming!" link="/about/cavaari" contact="cavaari@uoguelph.ca" discord="ctaylor_758"/>
                ...
                <Card name="Greg" imgSrc="/about/greg.png" contact="gklotz@uoguelph.ca"/> 
            </div>
        </div>
    )
}
