    ...
    return (
        <div className="p-5 bg-third d-flex flex-column align-items-center mx-auto">
            ...
            <div className="mt-3 mb-3 w-100 row row-cols-1 row-cols-md-3 row-cols-lg-4 g-2 d-flex justify-content-around">
                <Card name="Eric" imgSrc="/about/eric.jpg" description="IT Manager & Software Developer at Perpetual Motion Sports and creator of 3ric Games" link="/about/edearing" contact="edearing@uoguelph.ca" discord="ericdear"/>
                ...
                <Card name="Cavaari Taylor" imgSrc="/about/Memoji.jpeg" description="An island boy with a passion for programming!" link="/about/cavaari" contact="cavaari@uoguelph.ca" discord="ctaylor_758"/>
                ...
                <Card name="Muhammad" imgSrc="/about/Muhammad.png" description="Muhammad's description" link="/about/msalmaan" contact="msalmaan@uoguelph.ca" discord="msalmaan"/>
                <Card name="Tehreem" imgSrc="" description="Tehreem's description" link="/about/tnazar"  contact="tnazar@uoguelph.ca" discord="sshutup"/>
